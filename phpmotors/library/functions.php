...
function navBar($carclassifications){
    ...
    $navBar .= "<li><a href='/phpmotors/vehicles/?action=classification&classificationName="
...
function buildVehicleView($vehicleInfo){
    ...
    $vehicleView .= "<h2>$vehicleInfo[invMake] $vehicleInfo[invModel]</h2>";
    $vehicleView .= "<p class='grey'>$vehicleInfo[invDescription]</p>";
    $vehicleView .= "<p>Color: $vehicleInfo[invColor]</p>";
    $vehicleView .= "<p class='grey'># in stock: $vehicleInfo[invDescription]</p>";
    $vehicleView .= "</div>";
    return $vehicleView;
}
